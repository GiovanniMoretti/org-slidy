...
#+HTML_HEAD: <style> 
#+HTML_HEAD:   pre.src               {background-color: #FFFFCC; font-size:100%; font-family: Courier New, Courier, monospace;} 
...
#+HTML_HEAD:   pre.example           {background-color: #CCFFCC; font-size:100%; font-family: Courier New, Courier, monospace;} 
#+HTML_HEAD: </style> 
...
#+HTML_HEAD:    h3 {font-size:120%;color:#126; background-color:#FFF;}
